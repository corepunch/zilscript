...
return {
	...
	commands = {
		...
		{input="drop key",description="Drop safe key (no longer needed)"},
		...
		{input="drop notes",description="Drop Dr. Mordecai's notes (no longer needed)"},
		{input="take chapel key",inventory="CHAPEL-KEY",description="Take chapel key (iron key with cross)"},
