...
return {
	...
	commands = {
		...
		{ input="kill troll with sword", description="You are still recovering from that last blow, so your attack is ineffective." },
		{ input="kill troll with sword", description="Clang! Crash! The troll parries." },
		{ input="kill troll with sword", description="The troll is confused and can't fight back." },
		{ input="kill troll with sword", description="The troll is knocked out!" },
		{ input="kill troll with sword", description="The unarmed troll cannot defend himself: He dies." },
